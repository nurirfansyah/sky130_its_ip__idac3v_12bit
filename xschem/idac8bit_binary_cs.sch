...
C {icell8scs.sym} -320 540 0 0 {name=x9}
C {icell16scs.sym} -320 790 0 0 {name=x10}
C {icell32scs.sym} -320 1020 0 0 {name=x11}
C {devices/lab_pin.sym} -730 510 0 0 {name=p27 sig_type=std_logic lab=d3}
C {devices/lab_pin.sym} -730 760 0 0 {name=p28 sig_type=std_logic lab=d4}
C {devices/lab_pin.sym} -730 990 0 0 {name=p29 sig_type=std_logic lab=d5}
C {lvhvbuff.sym} -1130 110 0 0 {name=x12}
C {lvhvbuff.sym} -1120 600 0 0 {name=x13}
C {lvhvbuff.sym} -1120 710 0 0 {name=x14}
C {devices/ipin.sym} -1370 120 0 0 {name=p30 lab=din3}
C {devices/ipin.sym} -1340 610 0 0 {name=p31 lab=din4}
C {devices/ipin.sym} -1340 720 0 0 {name=p32 lab=din5}
C {devices/lab_pin.sym} -920 80 0 1 {name=p33 sig_type=std_logic lab=d3}
C {devices/lab_pin.sym} -900 570 0 1 {name=p34 sig_type=std_logic lab=d4}
C {devices/lab_pin.sym} -900 680 0 1 {name=p35 sig_type=std_logic lab=d5}
C {lvhvbuff.sym} -1120 830 0 0 {name=x15}
C {lvhvbuff.sym} -1120 940 0 0 {name=x16}
C {devices/ipin.sym} -1340 840 0 0 {name=p36 lab=din6}
C {devices/ipin.sym} -1340 950 0 0 {name=p37 lab=din7}
C {devices/lab_pin.sym} -900 800 0 1 {name=p38 sig_type=std_logic lab=d6}
C {devices/lab_pin.sym} -900 910 0 1 {name=p39 sig_type=std_logic lab=d7}
C {devices/lab_pin.sym} -730 1210 0 0 {name=p40 sig_type=std_logic lab=d6}
