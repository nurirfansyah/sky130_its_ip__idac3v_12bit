...
C {devices/vsource.sym} -370 -230 0 0 {name=V3 value="PULSE(1.8 0 50n 5n 5n 8u 16u)"}
C {devices/vsource.sym} -370 -120 0 0 {name=V4 value="PULSE(1.8 0 50n 5n 5n 16u 32u)"}
C {devices/vsource.sym} -370 -10 0 0 {name=V5 value="PULSE(1.8 0 50n 5n 5n 32u 64u)"}
...
C {devices/vsource.sym} -370 -570 0 0 {name=V9 value="PULSE(1.8 0 50n 5n 5n 1u 2u)"}
C {devices/vsource.sym} -370 -460 0 0 {name=V10 value="PULSE(1.8 0 50n 5n 5n 2u 4u)"}
C {devices/vsource.sym} -370 -350 0 0 {name=V11 value="PULSE(1.8 0 50n 5n 5n 4u 8u)"}
...
C {idac8bit_binary_cs.sym} 270 -40 0 0 {name=x1}
C {devices/vsource.sym} -590 -150 0 0 {name=V12 value="PULSE(1.8 0 50n 5n 5n 64u 128u)"}
C {devices/vsource.sym} -590 -40 0 0 {name=V13 value="PULSE(1.8 0 50n 5n 5n 128u 256u)"}
C {devices/lab_pin.sym} -540 -200 0 1 {name=p15 sig_type=std_logic lab=d6}
C {devices/lab_pin.sym} -540 -90 0 1 {name=p16 sig_type=std_logic lab=d7}
C {devices/lab_pin.sym} 90 50 0 0 {name=p17 sig_type=std_logic lab=d6}
C {devices/lab_pin.sym} 90 70 0 0 {name=p18 sig_type=std_logic lab=d7}
C {devices/vsource.sym} 600 90 0 0 {name=V14 value=0 savecurrent=false}
